...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        x =previous_high 
        if score0 - previous_score> x and who == 0 and score0 != 0:
            x= score0 - previous_score
            if x == 1:
                print (x , "point! That's the biggest gain yet for Player" , who)
            else:
                print (x , "points! That's the biggest gain yet for Player" , who)
            return announce_highest(0 ,x,score0)
        elif score1 - previous_score > x and who ==1 and score1 != 0:
            x = score1 - previous_score
            if x == 1:
                 print (x , "point! That's the biggest gain yet for Player" , who)
            else:
                print (x , "points! That's the biggest gain yet for Player" , who)
            return announce_highest(1 ,x,score1)
        if who == 0:
            return announce_highest(who, x , score0)
        else: 
            return announce_highest(who, x, score1)
    return announce
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if( score + free_bacon(opponent_score) < opponent_score) and (is_swap(score + free_bacon(opponent_score),opponent_score)):
        return 0
    else :
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if is_swap(score, opponent_score):
          n =  swap_strategy(score, opponent_score, 5, 4)
    else :
        n =bacon_strategy(score, opponent_score, 5, 4)
    return n
    # END PROBLEM 12
